    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.saved) {
            if (user.equals("")|| password.equals("")||firstName.equals("")||lastName.equals("")||dept.equals("")||position.equals("")||story.equals("")) {
                ...
                //  new CreatingProfile(this).execute("A20430435",user, password, firstName, lastName, "1000",dept,position,story,admin, loct, image, rewardRecords);


                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        new CreatingProfile(pa).execute("A20430435", user, password, firstName, lastName, "1000", dept, position, story, admin, loct, image, rewardRecords);
